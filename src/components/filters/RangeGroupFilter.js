      ...
      <div key={Math.random(1, 999)}>
        <div className="flex justify-between mt-4">
          <div className="flex items-center">
            ...
            <div className="text-xs text-bg-1 uppercase ml-4 font-bold tracking-1">
              ...
              <div className="InputRangeTextBox_input__2rEFp">
                <div className="input-group inline-block rounded relative w-full">
                  <input
                    ...
                    required=""
                    type="number"
                    className="p-1 mx-1 w-28 border transition text-14 input-field border-primary-2 focus:border-primary-4 bg-secondary-6 text-white placeholder-bg-2"
              ...
              <div className="InputRangeTextBox_input__2rEFp">
                <div className="input-group inline-block rounded relative w-full">
                  <input
                    size="20"
                    type="number"
                    className="p-1 mx-2 w-28 border transition text-14 input-field border-primary-2 focus:border-primary-4 bg-secondary-6 text-white placeholder-bg-2"
